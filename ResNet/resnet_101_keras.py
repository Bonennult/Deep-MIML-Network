...
from keras.layers import Input, Dense, Conv2D, MaxPooling2D, AveragePooling2D, ZeroPadding2D, Dropout, Flatten, merge, Reshape, Activation, Lambda, GlobalAveragePooling2D, Add  #, Merge
...
def resnet_predict(image_file):

    im = cv2.resize(cv2.imread(image_file), (224, 224)).astype(np.float32)
    ...
    if K.image_dim_ordering() == 'th':
        ...
        weights_path = 'ResNet/weights/resnet101_weights_th.h5'
    else:
        # Use pre-trained weights for Tensorflow backend
        weights_path = 'ResNet/weights/resnet101_weights_tf.h5'
