...
WEIGHTS_PATH = 'weights/resnet152_weights_tf.h5'
WEIGHTS_PATH_NO_TOP = 'weights/resnet152_weights_tf_notop.h5'
...
def ResNet152(include_top=True, weights=None,
    ...
    input_shape = _obtain_input_shape(input_shape,
                                      ...
                                      require_flatten=include_top)   #include_top=include_top)
    ...
    if weights == 'imagenet':
        ...
        model.load_weights(WEIGHTS_PATH, by_name=True)   #model.load_weights(weights_path, by_name=True)
        if K.backend() == 'theano':
